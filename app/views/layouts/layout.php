...
<div id="templatemo_container">
    ...
    <div id="templatemo_menu">
        <div id="pettabs" class="indentmenu">
            <ul>
                  <li><a href="index.html" rel="tab1" class="selected">Home</a></li>
                  <li><a href="#" rel="tab2">Services</a></li>
                  <li><a href="#" rel="tab3">Networks</a></li>
                  <li><a href="#" rel="tab4">Your Account</a></li>
	...
	<div id="templatemo_content">
        ...
        <div class="templatemo_content_section_01">
        	<div class="section_01_left">
              ...
              <p>This free CSS template is brought to you by <a title="free css templates" href="http://www.templatemo.com" target="_parent">TemplateMo.com</a>. You may use this template in your websites. Credit goes to <a href="http://www.photovaco.com" target="_blank">Free Photos</a> for photos used in this website.</p>
        ...
        <div class="templatemo_content_section_02">
            ...
            <div class="section_02_subsection">
                ...
                <ul>
                    ...
                    <li><a href="http://www.templatemo.com" target="_parent">CSS Web Templates</a></li>
					<li><a href="htp://www.webdesignmo.com" target="_parent">Web Design Blog</a></li>
...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
    ...
    <div id="templatemo_footer">
	       ...
	       <p><a href="#">Home</a> | <a href="#">Products</a> | <a href="#">Services</a> | <a href="#">FAQs</a> | <a href="#">Contact Us</a>
        	...
        	<p>Copyright © 2024 <a href="#"><strong>Your Company Name</strong></a> | Designed by <a href="http://www.templatemo.com" target="_parent">Free CSS Templates</a></p>
	</div> <!-- end of footer -->
